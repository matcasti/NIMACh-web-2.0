...
const NIMACH_DATA = {
  ...
  people: [
    ...
    },
    {
      ...
      bio:           'Kinesiólogo e investigador. Estudia aspectos funcionales, clinicos y celulares de la fragilidad y sarcopenia.',
      chips:         ['Fragilidad', 'Kinesiología'],
      links:         { researchgate: '#' },
    },
    {
      id:            'atenea-uribe',
      ...
      bio:           'Doctora en Bioquímica. Estudia mecanismos celulares y metabólicos del climaterio en la cognición y procesos neuroplásticos en mujeres.',
      chips:         ['Climaterio', 'Bioquímica'],
      links:         { researchgate: '#' },
    },
    {
